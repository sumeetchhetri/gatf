...
```sh
java -jar gatf-alldep-3.0.5.jar -executor /workdir/path/to/gatf/config.xml
```
...
```sh
java -jar gatf-alldep-3.0.5.jar -selenium /workdir/path/to/gatf/config.xml
```
...
```sh
java -jar gatf-alldep-3.0.5.jar -validate-sel test-script-name-relative-to-workdir.sel /workdir/path/to/gatf/config.xml
```
...
```sh
java -jar gatf-alldep-3.0.5.jar -listener
```
...
```sh
java -jar gatf-alldep-3.0.5.jar -configtool 9080 0.0.0.0 .
```
...
```sh
java -jar gatf-alldep-3.0.5.jar -generator /workdir/path/to/gatf/config.xml
```
