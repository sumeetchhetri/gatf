...
```sh
java -jar gatf-alldep-3.0.6.jar -executor /workdir/path/to/gatf/config.xml
```
...
```sh
java -jar gatf-alldep-3.0.6.jar -selenium /workdir/path/to/gatf/config.xml
```
...
```sh
java -jar gatf-alldep-3.0.6.jar -validate-sel test-script-name-relative-to-workdir.sel /workdir/path/to/gatf/config.xml
```
...
```sh
java -jar gatf-alldep-3.0.6.jar -listener
```
...
```sh
java -jar gatf-alldep-3.0.6.jar -configtool 9080 0.0.0.0 .
```
...
```sh
java -jar gatf-alldep-3.0.6.jar -generator /workdir/path/to/gatf/config.xml
```
