...
```sh
user@local> java -jar gatf-alldep-jar-1.0.0.jar -generator config.xml
```
...
<gatf-execute-config>
	...
	<gatfJarPath>C:\\Path-to-maven-repo\\.m2\\repository\\com\\github\\sumeetchhetri\\gatf\\gatf-alldep-jar\\1.0.0\\gatf-alldep-jar-1.0.0.jar</gatfJarPath>
...
```sh
user@local> java -jar gatf-alldep-jar-1.0.0.jar -configtool 9080 localhost .
```
