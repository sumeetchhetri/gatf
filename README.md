...
```sh
java -jar gatf-alldep-2.0.0.jar -executor /workdir/path/to/gatf/config.xml
```
...
```sh
java -jar gatf-alldep-2.0.0.jar -selenium /workdir/path/to/gatf/config.xml
```
...
```sh
java -jar gatf-alldep-2.0.0.jar -validate-sel test-script-name-relative-to-workdir.sel /workdir/path/to/gatf/config.xml
```
...
```sh
java -jar gatf-alldep-2.0.0.jar -listener
```
...
```sh
java -jar gatf-alldep-2.0.0.jar -configtool 9080 0.0.0.0 .
```
...
```sh
java -jar gatf-alldep-2.0.0.jar -generator /workdir/path/to/gatf/config.xml
```
