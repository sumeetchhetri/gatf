 ...
 */
public class GatfPrettyPrintWriter extends AbstractWriter {
    ...
    private final String[] cdataNodes;
    ...
    public GatfPrettyPrintWriter(Writer writer, char[] lineIndenter) {
     ...
     * @deprecated As of 1.3
     */
    public GatfPrettyPrintWriter(Writer writer, String lineIndenter, String newLine) {
     ...
     * @since 1.3
     */
    public GatfPrettyPrintWriter(Writer writer, int mode, String lineIndenter) {
        this(writer, mode, lineIndenter.toCharArray());
    }

    public GatfPrettyPrintWriter(Writer writer, String lineIndenter) {
     ...
     * @since 1.4
     */
    public GatfPrettyPrintWriter(Writer writer, int mode, NameCoder nameCoder) {
     ...
     * @since 1.4
     */
    public GatfPrettyPrintWriter(Writer writer, NameCoder nameCoder) {
     ...
     * @since 1.3
     */
    public GatfPrettyPrintWriter(Writer writer, int mode) {
